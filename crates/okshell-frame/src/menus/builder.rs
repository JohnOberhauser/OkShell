use relm4::{gtk, Component, ComponentSender};
...
use crate::menus::menu_widgets::app_launcher::app_launcher::{AppLauncherInit, AppLauncherModel, AppLauncherOutput};
use crate::menus::menu_widgets::audio_in::audio_in_menu_widget::{AudioInMenuWidgetInit, AudioInMenuWidgetModel};
use crate::menus::menu_widgets::audio_out::audio_out_menu_widget::{AudioOutMenuWidgetInit, AudioOutMenuWidgetModel};
use crate::menus::menu_widgets::bluetooth::bluetooth_menu_widget::{BluetoothMenuWidgetInit, BluetoothMenuWidgetModel};
use crate::menus::menu_widgets::calendar::{CalendarInit, CalendarModel};
use crate::menus::menu_widgets::clipboard::clipboard::{ClipboardInit, ClipboardModel, ClipboardOutput};
...
use crate::menus::menu_widgets::media_player::media_players::{MediaPlayersInit, MediaPlayersModel};
use crate::menus::menu_widgets::network::network_menu_widget::{NetworkMenuWidgetInit, NetworkMenuWidgetModel};
use crate::menus::menu_widgets::notifications::notifications::{NotificationsInit, NotificationsModel, NotificationsOutput};
use crate::menus::menu_widgets::power_profile::power_profile_menu_widget::{PowerProfileMenuWidgetInit, PowerProfileMenuWidgetModel};
use crate::menus::menu_widgets::quick_action::quick_actions::{QuickActionsInit, QuickActionsModel, QuickActionsOutput};
            ...
            Box::new(
                AppLauncherModel::builder()
                    ...
                    .forward(sender.output_sender(), |msg| {
                        match msg { AppLauncherOutput::CloseMenu => {
        ...
        MenuWidget::Screenshots => {
            Box::new(
                ScreenshotMenuWidgetModel::builder()
                    ...
                    .forward(sender.output_sender(), |msg| {
                        match msg { ScreenshotMenuWidgetOutput::CloseMenu => {
                            MenuOutput::CloseMenu
                        } }
                    })
            )
        ...
        MenuWidget::ScreenRecording => {
            Box::new(
                ScreenRecordMenuWidgetModel::builder()
                    ...
                    .forward(sender.output_sender(), |msg| {
                        match msg { ScreenRecordMenuWidgetOutput::CloseMenu => {
                            MenuOutput::CloseMenu
                        } }
                    })
            )
