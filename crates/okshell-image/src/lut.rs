...
const CLUT_BOO: &[u8] = include_bytes!("../cluts/boo.bin");
...
const CLUT_CRIMSON_MOONLIGHT: &[u8] = include_bytes!("../cluts/crimson_moonlight.bin");
...
const CLUT_FOREST_STREAM: &[u8] = include_bytes!("../cluts/forest_stream.bin");
...
const CLUT_NIGHTFOX: &[u8] = include_bytes!("../cluts/nightfox.bin");
...
const CLUT_RADIOACTIVE: &[u8] = include_bytes!("../cluts/radioactive.bin");
...
const CLUT_SUNSET_CLOUD: &[u8] = include_bytes!("../cluts/sunset_cloud.bin");
...
pub fn embedded_clut(theme: &Themes) -> Option<&'static [u8]> {
    match theme {
        ...
        Themes::CrimsonMoonlight => Some(CLUT_CRIMSON_MOONLIGHT),
        ...
        Themes::ForestStream => Some(CLUT_FOREST_STREAM),
        ...
        Themes::Nightfox => Some(CLUT_NIGHTFOX),
        ...
        Themes::Radioactive => Some(CLUT_RADIOACTIVE),
        ...
        Themes::SunsetCloud => Some(CLUT_SUNSET_CLOUD),
