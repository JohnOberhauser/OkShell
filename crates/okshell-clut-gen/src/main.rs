...
fn static_themes() -> Vec<(&'static str, Themes)> {
    vec![
        ...
        ("crimson_moonlight", Themes::CrimsonMoonlight),
        ...
        ("forest_stream", Themes::ForestStream),
        ...
        ("radioactive", Themes::Radioactive),
        ...
        ("sunset_cloud", Themes::SunsetCloud),
...
fn main() {
    let out_dir = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .parent()
        .expect("okshell_clut_gen must be in a workspace")
        .join("okshell-image")
        .join("cluts");
