...
use crate::static_themes::nightfox::nightfox;
...
pub fn static_theme(theme: &Themes, okshell: Option<OkShell>) -> Option<MatugenTheme> {
    ...
    match theme {
        ...
        Themes::InkyPinky => Some(inky_pinky(okshell)),
        ...
        Themes::MonokaiClassic => Some(monokai_classic(okshell)),
        Themes::Nightfox => Some(nightfox(okshell)),
